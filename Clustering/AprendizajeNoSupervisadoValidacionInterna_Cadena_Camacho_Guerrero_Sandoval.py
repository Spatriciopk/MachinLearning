# -*- coding: utf-8 -*-
"""
Created on Thu Jun  9 15:56:16 2022
...
df = pd.read_csv("https://archive.ics.uci.edu/ml/machine-learning-databases/00307/%5bUCI%5d%20AAAI-14%20Accepted%20Papers%20-%20Papers.csv")
df = pd.DataFrame(df)
del df["authors"]
del df["topics"]
df_group = df["groups"]
...
clus5 = lista_clusters_l.count(4)
clus = [clus1,clus2,clus3,clus4,clus5]
...
plt.show()
print("El promedio o Average solhouette witdh KMeans: ", round(silhouette_avg,2))