...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/home/spatricio/Escritorio/MachinLearning/deploy'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/home/spatricio/Escritorio/MachinLearning/deploy/bin/deactivate.nu'
